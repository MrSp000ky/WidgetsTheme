...
import 'package:widgets_2024_1/presentation/widgets/widgets.dart';

class SnackbarScreen extends StatelessWidget with AppBarCustom,CustomSnackBars {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
          onPressed: () => toShowSnackBarCustom(context,
              snackBarContent: const Text('Aloh Miguel Camacho')),
